...
Next up: I'm planning to tackle the multivariate Gaussian (Problem 2.3). That one's going to involve some matrix calculus, but it's fundamental for understanding things like PCA and Gaussian processes.
