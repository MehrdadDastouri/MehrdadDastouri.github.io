...
<!-- 
  CSS fix for horizontal overflow in blog posts on mobile.
  This prevents wide elements like LaTeX formulas or code blocks
  from stretching the entire page layout. Instead, a horizontal
  scrollbar will appear only for the overflowing element itself.
-->
<style>
