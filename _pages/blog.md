...
<!-- 
  Manually added header to replicate the style from 'page' layout
  without its problematic container structure.
-->
...
<hr> <!-- Optional: a horizontal rule for visual separation -->
